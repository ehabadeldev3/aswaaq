...
<html style="-moz-osx-font-smoothing: grayscale; -webkit-font-smoothing: antialiased; background-color: #464646; margin: 0; padding: 0;">
    <head>
        ...
        <title><?php echo app('translator')->get('message.Aswaaq'); ?></title>

        <style>
            .successLogo{
                filter: brightness(85%) contrast(120%) hue-rotate(-10deg) saturate(120%);
                filter: grayscale(0%);
                filter: sepia(0%);
                filter: invert(0%);
                filter: opacity(100%);
    ...
    <body bgcolor="#d7d7d7" class="generic-template" style="-moz-osx-font-smoothing: grayscale; -webkit-font-smoothing: antialiased; background-color: #d7d7d7; margin: 0; padding: 0;">
        ...
        <div class="bg-white header" bgcolor="#ffffff" style="background-color: white; width: 100%;">
            <table align="center" bgcolor="#ffffff" style="border-left: 10px solid white; border-right: 10px solid white; max-width: 600px; width: 100%;">
                <tr height="80">
                    <td align="left" class="vertical-align-middle" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: middle;text-align:center">
                        <a style="-webkit-text-decoration-color: #ff6a13; color: #ff6a13; text-decoration: none; text-decoration-color: #ff6a13;">
                            <img src="/web/img/logo.png" alt="GO" width="140" height="140" style="border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;">
                        </a>
                    </td>
                </tr>
            </table>
 ...
 <!-- Generic Pod Left Aligned with Price breakdown Start -->
                    <table align="center" cellpadding="0" cellspacing="0" cols="3" bgcolor="white" class="bordered-left-right" style="border-left: 10px solid #d7d7d7; border-right: 10px solid #d7d7d7; max-width: 600px; width: 100%;">
                        ...
                        <tr align="center">
                            ...
                            <td class="text-primary" style="color: #ff6a13; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                <img src="http://dgtlmrktng.s3.amazonaws.com/go/emails/generic-email-template/tick.png" class="successLogo"  alt="Aswaaq" width="50" style="filter: brightness(85%) contrast(120%) hue-rotate(-10deg) saturate(120%);border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;">
                            </td>
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        </tr>
                        ...
                        <tr align="center">
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                            <td class="text-primary" style="color: #ff6a13; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                <h1 style="color: #ff6a13; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: 700; line-height: 34px; margin-bottom: 0; margin-top: 0;"><?php echo app('translator')->get('message.Payment received'); ?></h1>
                            </td>
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        </tr>
                        <tr align="left">
                            ...
                            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">
                                    <?php echo app('translator')->get('message.Hi'); ?> <?php echo e($user_name); ?>,
                                </p>
                            </td>
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        </tr>
                        ...
                        <tr align="left">
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><?php echo app('translator')->get('message.Your transaction was successful!'); ?></p>
                                <br>
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; "><strong><?php echo app('translator')->get('message.Payment Details:'); ?></strong><br/>

                                    <?php echo app('translator')->get('message.Amount:'); ?> <?php echo e($total_amount); ?> <?php echo app('translator')->get('message.LE'); ?><br/>
                                                        <br/></p>
                                    <br>
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><?php echo app('translator')->get('message.We advise to keep this email for future reference.'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<br/></p>
                            </td>
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        </tr>
                        <tr height="30">
                        ...
                        <tr align="center">
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><strong><?php echo app('translator')->get('message.Transaction reference:'); ?><?php echo e($transaction_id); ?></strong></p>
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><strong><?php echo app('translator')->get('message.Invoice ID:'); ?> <?php echo e($invoice_id); ?></strong></p>
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><?php echo app('translator')->get('message.Payment date:'); ?> <?php echo e($date); ?></p>
            ...
            <table align="center" bgcolor="#464646" style="max-width: 600px; width: 100%;">
                ...
                <tr>
                    <td align="center" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                        <img src="/web/img/logo.png" alt="Aswaaq" width="100" height="100" style="border: 0; font-size: 0; margin: 0; max-width: 100%; padding: 0;">
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                        <p class="text-white" style="color: white; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">Copyright © Aswaaq 2023. All rights reserved.</p>
                        <p class="text-primary" style="color: #ff6a13; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">
                        </p>
                    </td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\Aswaaq-misr\resources\views/success_payment.blade.php ENDPATH**/ ?>