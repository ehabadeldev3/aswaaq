        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{$t('global.Provinces')}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexProvince'}">{{$t('global.Provinces')}}</router-link></li>
...
export default {
    ...
    setup(props){
        ...
        let getMainAreaViews = () => {
            ...
            adminApi.get(`/v1/dashboard/province/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addArea.data.name_ar = l.province.name_ar;
                    addArea.data.name_en = l.province.name_en;
                })
                .catch((err) => {
    ...
    methods: {
        editArea(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/province/${this.id}`,this.data)
                    .then((res) => {
                        notify({
