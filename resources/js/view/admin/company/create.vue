                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.Add Company') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="storeCOompany" class="needs-validation">
                                        ...
                                        <button class="btn btn-primary" type="submit">{{ $t('global.Add') }}</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    setup(){
        ...
        return {loading,...toRefs(addCompany),v$,preview,numberOfImage,t};
    },
    methods: {
        storeCOompany(){
            this.v$.$validate();
