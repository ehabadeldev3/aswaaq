                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.Update Company') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
    ...
    setup(props){
        ...
        let getCompany = () => {
            ...
            adminApi.get(`/v1/dashboard/company/${id.value}/edit`)
                .then((res) => {
                    ...
                    addCompany.data.name_ar = l.company.name_ar;
                    addCompany.data.name_en = l.company.name_en;
        ...
        return {id,loading,...toRefs(addCompany),v$,preview,numberOfImage,image,t};
    },
    methods: {
        editSupplier(){
            this.v$.$validate();
