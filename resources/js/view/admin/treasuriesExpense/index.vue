                ...
                <div class="card-body pt-0">
                    ...
                    <div class="reviews-menu-links">
                        <ul role="tablist" class="nav nav-pills card-header-pills nav-justified">
                            <li class="nav-item">
                                <a href="#tab-4" data-bs-toggle="tab" class="nav-link active">{{ $t('global.ExpenseItems')
                                }}</a>
                            </li>
                            <!-- <li class="nav-item">
...
export default {
    ...
    setup() {
        ...
        return { expense, income, income_transfer, expense_transfer, amount, treasury_id, incomes, treasuries, loading, getIncome, dateFormat, search, incomesPaginate };
