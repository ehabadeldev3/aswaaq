            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexSize'}">{{$t('global.Sizes')}}</router-link></li>
                            <li class="breadcrumb-item active">{{$t('permission.size edit')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="editSize" class="needs-validation">
...
export default {
    ...
    setup(props){
        ...
        let getSize = () => {
            ...
            adminApi.get(`/v1/dashboard/size/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addSize.data.name_ar = l.size.name_ar;
                    addSize.data.name_en = l.size.name_en;
                })
                .catch((err) => {
        ...
        const v$ = useVuelidate(rules,addSize.data);


        return {loading,...toRefs(addSize),v$,t};
    },
    methods: {
        editSize(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/size/${this.id}`,this.data)
                    .then((res) => {
