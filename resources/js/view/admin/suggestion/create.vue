                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <div class="alert alert-danger text-center" v-if="errors['name_en']">{{ errors['name_en'][0] }}<br /> </div>                                    <form @submit.prevent="storeJob" class="needs-validation">
    ...
    methods: {
        storeJob(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/suggestion`,this.data)
                    .then((res) => {
