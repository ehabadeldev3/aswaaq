                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.Suggestions') }}</li>
                        </ul>
                    </div>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createSuggestion'}"
                                            v-if="permission.includes('Suggestions create')"
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in jobs" :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editSuggestion', params: {id:item.id}}"
                                                v-if="permission.includes('Suggestions edit')"
                                                class="btn btn-sm btn-success me-2">
                                                <i class="far fa-edit"></i>
                                            </router-link>
                                            <a href="#" @click="deleteJob(item.id,item.name,index)"
                                               v-if="permission.includes('Suggestions delete')"
...
export default {
    ...
    setup() {
        ...
        let getJob = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/suggestion?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
...
confirmButtonText: t('global.Yes')
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/suggestion/${id}`)
                        .then((res) => {
        ...
        return {jobs, loading, getJob, search, deleteJob,permission, jobsPaginate};
