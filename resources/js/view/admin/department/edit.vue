            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexDepartment'}">{{$t('global.Department')}}</router-link></li>
    ...
    setup(props){
        ...
        let getMainDepartmentViews = () => {
            ...
            adminApi.get(`/v1/dashboard/department/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addDepartment.data.name_ar = l.department.name_ar;
                    addDepartment.data.name_en = l.department.name_en;
                    console.log(l)
                })
                .catch((err) => {
