                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{$t('global.Update Supplier')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       :class="{'is-invalid':v$.commerical_register.$error,'is-valid':!v$.commerical_register.$invalid}"
                                                >
                                                <div class="valid-feedback">{{$t('global.LooksGood')}}</div>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       :class="{'is-invalid':v$.responsible_name.$error,'is-valid':!v$.responsible_name.$invalid}"
                                                >
                                                <div class="valid-feedback">{{$t('global.LooksGood')}}</div>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       :class="{'is-invalid':v$.responsible_phone.$error,'is-valid':!v$.responsible_phone.$invalid}"
                                                >
                                                <div class="valid-feedback">{{$t('global.LooksGood')}}</div>
                                                <div class="invalid-feedback">
...
export default {
    ...
    setup(props){
        ...
        let getSupplier = () => {
            ...
            adminApi.get(`/v1/dashboard/supplier/${id.value}/edit`)
                .then((res) => {
                    ...
                    addSupplier.data.tax_card = l.supplier.tax_card;
                    addSupplier.data.commerical_register = l.supplier.commerical_register;
                    addSupplier.data.commission_percentage = l.supplier.commission_percentage;
                    addSupplier.data.responsible_name = l.supplier.responsible_name;
                    addSupplier.data.responsible_phone = l.supplier.responsible_phone;
                    addSupplier.data.is_our_supplier = l.supplier.is_our_supplier == 1 ? true : false;
                    addSupplier.data.days = l.workdays;
                })
                .catch((err) => {
                ...
                .finally(() => {
                    loading.value = false;
                    setTimeout(() => {
                        addSupplier.data.areas = areas.value
                    },1000)
                })
        }
        ...
        return {loading,...toRefs(addSupplier),v$,t,areas_data,days_data};
    },
    methods: {
        editSupplier(){
            this.v$.$validate();
