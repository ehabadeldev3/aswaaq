                    ...
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexFirstSliderAds'}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <div class="alert alert-danger text-center" v-if="errors['sub_category_id']">
                                        {{ errors['sub_category_id'][0] }}<br/></div>
                                    ...
                                    <form @submit.prevent="storeAds" class="needs-validation">
...
export default {
    ...
    setup() {
        ...
        return {products,sub_categories,preview, t, loading, ...toRefs(addEmployee), v$,requiredn,numberOfImage,empty,select_product,product_search,selected_product_image,selected_product_name,select_sub_category,loading2,sub_category_search,selected_sub_category_image,selected_sub_category_name};
    },
    methods: {
        storeAds() {
            this.v$.$validate();
