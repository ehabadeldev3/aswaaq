                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.secondSliderAds') }}</li>
                        </ul>
                    </div>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in ads" :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editSecondSliderAds', params: {id:item.id}}"
...
export default {
    ...
    setup() {
        ...
        let getAds = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/ads?page=${page}&search=${search.value}&place=2`)
                .then((res) => {
                    let l = res.data.data;
