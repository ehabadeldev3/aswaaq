            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexCar'}">{{$t('global.Cars')}}</router-link></li>
                            <li class="breadcrumb-item active">{{$t('global.Add Car')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="storeCar" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="valid-feedback">{{$t('global.LooksGood')}}</div>
                                                <div class="invalid-feedback">
                                                    <span v-if="v$.phone.integer.$invalid">{{$t('global.ThisFieldMustBeANumber')}}  <br /></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom0333">{{$t('global.Plate Number')}} </label>
                                                <input type="text" class="form-control"
                                                       v-model.trim="v$.plate_number.$model"
                                                       id="validationCustom0333"
                                                       :class="{'is-invalid':v$.plate_number.$error,'is-valid':!v$.plate_number.$invalid}"
                                                >
                                                <div class="valid-feedback">{{$t('global.LooksGood')}}</div>
                                                <div class="invalid-feedback">
                                                    <span v-if="v$.plate_number.required.$invalid"> {{ $t('global.IsRequired') }}<br /> </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-9 row flex-fill">
                                                ...
                                                <div class="container-images" id="container-images1" v-show="data.license && numberOfImage1"></div>
    ...
    methods: {
        ...
        storeCar(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/car`,formData)
                    .then((res) => {
