            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexFlavor'}">{{$t('global.Flavors')}}</router-link></li>
                            <li class="breadcrumb-item active">{{$t('permission.flavor edit')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="editFlavor" class="needs-validation">
...
export default {
    ...
    setup(props){
        ...
        let getFlavor = () => {
            ...
            adminApi.get(`/v1/dashboard/flavor/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addFlavor.data.name_ar = l.flavor.name_ar;
                    addFlavor.data.name_en = l.flavor.name_en;
                })
                .catch((err) => {
        ...
        const v$ = useVuelidate(rules,addFlavor.data);


        return {loading,...toRefs(addFlavor),v$,t};
    },
    methods: {
        editFlavor(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/flavor/${this.id}`,this.data)
                    .then((res) => {
