                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createArea'}"
                                            v-if="permission.includes('areas create')"
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>{{ $t('global.Name') }}</th>
                                        <th>{{ $t('global.Province') }}</th>
                                        <th>{{ $t('global.shippingPrice') }}</th>
                                    ...
                                    <tr v-for="(item,index) in areas" :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editArea', params: {id:item.id}}"
                                                v-if="permission.includes('areas edit')"
                                                class="btn btn-sm btn-success me-2">
                                                <i class="far fa-edit"></i>
                                            </router-link>
                                            <a href="#" @click="deleteArea(item.id,item.name,index)"
                                               v-if="permission.includes('areas delete')"
...
export default {
    ...
    setup() {
        ...
        function deleteArea(id, jobName, index) {
            Swal.fire({
        ...
        return {areas, loading, getArea, search, deleteArea,permission, areasPaginate};
