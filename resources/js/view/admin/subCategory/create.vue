                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.Add Sub Category') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
    ...
    setup(){
        ...
        let getCategories= () => {
            ...
            adminApi.get(`/v1/dashboard/subCategory/create`)
                .then((res) => {
                    let l = res.data.data;
        ...
        return {categories,loading,...toRefs(addCategory),v$,preview,numberOfImage,t};
    },
    methods: {
        storeCategory(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/subCategory`,formData)
                    .then((res) => {
